# http://www.codeskulptor.org/#user39_LxPgKiXPw0Vzhcu.py
# Pong
...
def draw(canvas):
    ...
    canvas.draw_line([WIDTH / 2, 0],[WIDTH / 2, HEIGHT], 1, "#00FF00")
    canvas.draw_line([PAD_WIDTH, 0],[PAD_WIDTH, HEIGHT], 1, "#00FF00")
    canvas.draw_line([WIDTH - PAD_WIDTH, 0],[WIDTH - PAD_WIDTH, HEIGHT], 1, "#00FF00")
